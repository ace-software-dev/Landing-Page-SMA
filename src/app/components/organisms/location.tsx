...
export default function Location() {
  ...
  return (
    <section id="ubicacion" className='flex flex-col items-center mx-5  md:mx-10 max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-5xl xl:max-w-7xl'>
      <div className="flex flex-col gap-6 md:gap-10 lg:gap-16 xl:gap-20 lg:flex-row">

        <div className='flex flex-col gap-4 sm:gap-5 md:gap-6 justify-center w-full lg:w-1/3'>
          <SectionTitle
          ...
          <div className='flex flex-row justify-center'>
            <RoundedButton classes='text-sm md:text-base lg:text-lg'>
